...
class SellerRateCardImport implements ToModel, WithHeadingRow, WithValidation, SkipsOnFailure
{
    use SkipsFailures;
    protected int $companyId;
    protected int $sellerCompanyId;

    public function __construct(int $companyId,int $sellerCompanyId)
    {
    ...
    public function model(array $row)
    {
        ...
        return SellerRateCard::updateOrCreate(
            [
                'company_id'     => $this->sellerCompanyId,
