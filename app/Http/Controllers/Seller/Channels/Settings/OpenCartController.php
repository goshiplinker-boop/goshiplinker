...
class OpenCartController extends Controller
{
    ...
    {
        return view("seller.channels.settings.opencart.create");
    }
    ...
    public function store(Request $request)
    {
        ...
        $validatedData = $request->validate([
            ...
            'other_details.fetch_status' => 'required|string|max:255',
            'other_details.order_tags' => 'nullable|string|max:255',
        ...
        $channel = Channel::create([
            ...
            "parent_id" => "10", // Assuming the parent ID is static
            "name" => $validatedData["channel_title"],
            "status" => $validatedData["status"],
            "image_url" => "images/channels/opencart.png", // Set default image
        ]);
        ...
        $existingSetting = ChannelSetting::where('channel_url', $validatedData['channel_url'])->first();

        if ($existingSetting) {
            return back()->withErrors(['channel_url' => 'This URL is already connected to a channel.'])->withInput();
        }
        ...
        return redirect()
            ->route("channels_list")
            ->with("success", "Opencart setting created successfully.");
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('seller.channels.settings.opencart.edit', compact(['opencart','payment_types']));
    }
