    ...
    <x-slot name="main">
        ...
        <div class="row">    
            <div class="card col-sm-12">
                <div class="card-body">                    
                    <form class="needs-validation" action="{{ route('seller.pincodes.import') }}" method="POST" enctype="multipart/form-data" novalidate>
                        @csrf
                        <div class="row">
                           ...
                           <div class="col-sm-6 mb-3">
                            ...
                            <div class="col-sm-6 mb-3">
                                ...
                                <a href="{{ asset(env('PUBLIC_ASSETS') . '/templates/seller_pincode_sample.csv') }}" class="btn-ghost-primary btn-sm">
