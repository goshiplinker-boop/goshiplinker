<x-layout>
    <x-slot name="title">DTDC</x-slot>
    <x-slot name="breadcrumbs">DTDC</x-slot>   
    <x-slot name="page_header_title"><h1 class="page-header-title">DTDC</h1></x-slot>
    ...
    <x-slot name="main">       
        ...
        <div class="row">
            ...
            <div class="card col-sm-8">
                <div class="card-body">
                    <form class="needs-validation" method="POST" action="{{ route(panelPrefix().'.dtdc.update', $dtdc->courier_id) }}" id="dtdc-form" novalidate>
                        @include('seller.couriers.settings.dtdc.form')
