    ...
    <x-slot name="main">       
        ...
        <div class="row">
            ...
            <div class="card col-sm-8">
                <div class="card-body">
                    <form class="needs-validation" method="POST" action="{{ route(panelPrefix().$nimbus_post->courier_code.'.update', $nimbus_post->courier_id) }}" id="nimbus_post-form" novalidate>
