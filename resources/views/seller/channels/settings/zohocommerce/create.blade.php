<x-layout>
    <x-slot name="title">{{__('message.woocommerce.heading_title')}}</x-slot>
    <x-slot name="breadcrumbs"> {{ Breadcrumbs::render('woocommerce.create') }} </x-slot>
    <x-slot name="page_header_title"><h1 class="page-header-title">{{__('message.woocommerce.page_header_title')}}</h1></x-slot>
    ...
    <x-slot name="main">
        <div class="row">
            ...
            <div class="card col-sm-8">
                <div class="card-body">
                    <form class="needs-validation" action="{{ route('zoho_commerce.store') }}" id="woocommerce-form"
