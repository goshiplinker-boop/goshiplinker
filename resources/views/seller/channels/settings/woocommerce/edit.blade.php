            ...
            <div class="card-body">
               ...
               <form class="needs-validation" action="{{ route('woocommerce.update', $woocommerce->channel_id) }}" id="woocommerce-form" method="POST" enctype="multipart/form-data" novalidate>
                  ...
                  <div class="tab-content">
                              ...
                              <div class="input-group input-group-sm-vertical">
                                 <label class="form-control d-flex align-items-center" style="cursor: pointer;">
                                       <input type="radio" class="form-check-input me-2" value="1" name="other_details[auto_sync]"
                                          {{ old('other_details.auto_sync', $woocommerce->other_details['auto_sync'] ?? '0') == '1' ? 'checked' : '' }}
                                          required>
                                 ...
                                 <label class="form-control d-flex align-items-center" style="cursor: pointer;">
                                       <input type="radio" class="form-check-input me-2" value="0" name="other_details[auto_sync]"
                                          {{ old('other_details.auto_sync', $woocommerce->other_details['auto_sync'] ?? '0') == '0' ? 'checked' : '' }}
                                          required>
                     ...
                     <div class="tab-pane fade my-2" id="nav-three-eg1" role="tabpanel" aria-labelledby="nav-two-eg1-tab">
