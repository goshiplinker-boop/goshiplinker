<header id="header"
    ...
    <div class="navbar-nav-wrap">
        ...
        <a class="navbar-brand" href="../index.html" aria-label="Front">
            <img class="navbar-brand-logo" src="{{ asset(env('PUBLIC_ASSETS') . '/images/logo/PM_Logo.png') }}" alt="Logo"
            ...
            <img class="navbar-brand-logo-mini" src="{{ asset(env('PUBLIC_ASSETS') . '/images/logo/logo-short.png') }}"
                alt="Logo" data-hs-theme-appearance="default">
            <img class="navbar-brand-logo-mini"
                src="{{ asset(env('PUBLIC_ASSETS') . '/images/logo/logo-short.png') }}" alt="Logo"
        ...
        <div class="navbar-nav-wrap-content-start">
            ...
            <!-- Search Form -->
                <!-- @if((Request::segment(1) !='admin') && session()->has('company_id'))
                    ...
                    @elseif(session('subscription_plan')=='trial' && session('subscription_status')=='1')
                        <div class="lead">You have 7 days of free trial left, Checkout our premium plan <a href="{{ route('subscription_plans') }}">here</a></div>
                    @endif 
                @endif   -->
            @if((Request::segment(1) !='admin') && session()->has('company_id'))
            @endif 
            <div class="d-none dropdown ms-2">
                <!-- Input Group -->
                        ...
                        <div class="card-body-height">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img class="avatar avatar-xs avatar-circle"
                                            src="{{ asset(env('PUBLIC_ASSETS') . '/img/160x160/img10.jpg') }}"
                            ...
                            <a class="dropdown-item" href="../index.html">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img class="avatar avatar-xs avatar-circle"
                                            src="{{ asset(env('PUBLIC_ASSETS') . '/img/160x160/img3.jpg') }}"
                                            alt="Image Description">
                                    </div>
                                    <div class="flex-grow-1 text-truncate ms-2">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-auto">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="avatar avatar-sm avatar-circle">
                                                                    <img class="avatar-img"
                                                                        src="{{ asset(env('PUBLIC_ASSETS') . '/svg/brands/google-icon.svg') }}"
                                                                        alt="Image Description">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-auto">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="avatar avatar-sm avatar-circle">
                                                                    <img class="avatar-img"
                                                                        src="{{ asset(env('PUBLIC_ASSETS') . '/img/160x160/img7.jpg') }}"
                                                                        alt="Image Description">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-auto">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="avatar avatar-sm avatar-circle">
                                                                    <img class="avatar-img"
                                                                        src="{{ asset(env('PUBLIC_ASSETS') . '/img/160x160/img5.jpg') }}"
                                                                        alt="Image Description">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-auto">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="avatar avatar-sm avatar-circle">
                                                                    <img class="avatar-img"
                                                                        src="{{ asset(env('PUBLIC_ASSETS') . '/img/160x160/img8.jpg') }}"
                                                                        alt="Image Description">
                                                                </div>
                                                            </div>
                                                        </div>
                                ...
                                <div class="card-body card-body-height">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img class="avatar avatar-xs avatar-4x3"
                                                    src="{{ asset(env('PUBLIC_ASSETS') . '/svg/brands/atlassian-icon.svg') }}"
                                                    alt="Image Description">
                                            </div>
                                    ...
                                    <a class="dropdown-item" href="#">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img class="avatar avatar-xs avatar-4x3"
                                                    src="{{ asset(env('PUBLIC_ASSETS') . '/svg/brands/slack-icon.svg') }}"
                                                    alt="Image Description">
                                            </div>
                                            <div class="flex-grow-1 text-truncate ms-3">
                                    ...
                                    <a class="dropdown-item" href="#">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img class="avatar avatar-xs avatar-4x3"
                                                    src="{{ asset(env('PUBLIC_ASSETS') . '/svg/brands/google-webdev-icon.svg') }}"
                                                    alt="Image Description">
                                            </div>
                                            <div class="flex-grow-1 text-truncate ms-3">
       ...
       <h5 class="mb-0">Google webdev</h5>
                                    ...
                                    <a class="dropdown-item" href="#">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img class="avatar avatar-xs avatar-4x3"
                                                    src="{{ asset(env('PUBLIC_ASSETS') . '/svg/brands/frontapp-icon.svg') }}"
                                                    alt="Image Description">
                                            </div>
                                            <div class="flex-grow-1 text-truncate ms-3">
                                    ...
                                    <a class="dropdown-item" href="#">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img class="avatar avatar-xs avatar-4x3"
                                                    src="{{ asset(env('PUBLIC_ASSETS') . '/svg/illustrations/review-rating-shield.svg') }}"
                                                    alt="Image Description">
                                            </div>
                                            <div class="flex-grow-1 text-truncate ms-3">
                ...
                @if(Request::segment(1)=='seller')
                 <li class="nav-item display-6">
                    <span class="badge bg-warning text-dark"><i class="bi bi-wallet2"></i> 
                    ₹{{ number_format(optional(auth('web')->user()->company?->wallet)->balance ?? 0, 2) }}
                    </span>
                ...
                <li class="nav-item">
                    ...
                    <div class="dropdown">
                        <a class="navbar-dropdown-account-wrapper" href="javascript:;" id="accountNavbarDropdown"
                            ...
                            <div class="avatar avatar-sm avatar-circle">
                                <img class="avatar-img"
                                    src="{{ asset(env('PUBLIC_ASSETS') . '/img/160x160/img6.jpg') }}"
                                    alt="Image Description">
                        ...
                        <div class="dropdown-menu dropdown-menu-end navbar-dropdown-menu navbar-dropdown-menu-borderless navbar-dropdown-account"
                            ...
                            <div class="dropdown-item-text">
                                <div class="d-flex align-items-center">
                                    ...
                                    @if(Request::segment(1) !='admin')
                                        @if (isset(auth()->guard('web')->user()->company))
                                            <h5 class="mb-0">
                                                {{ !empty(auth()->guard('web')->user()->company->legal_registered_name)
                                                    ? auth()->guard('web')->user()->company->legal_registered_name
                                                    : auth()->guard('web')->user()->name }}
                                            </h5>
                                            <p class="card-text text-body text-break">
                                                {{ auth()->guard('web')->user()->company->company_email_id }}
                                            </p>
                                        @endif
                                    @else                                        
                                        <h5 class="mb-0">
                            ...
                            <div class="dropdown-divider"></div>
                            @if(Request::segment(1) !='admin')
                                <a class="dropdown-item" href="@if(session()->has('company_id')) {{ route('profile', session('company_id')) }} @else # @endif">Profile</a>
                            @endif
                            <a class="dropdown-item" href="@if(Request::segment(1)=='admin'){{route('admin.logout')}} @else {{route('logout')}} @endif">Sign out</a>
                        </div>
                    </div>
                    <!-- End Account -->
                </li>
